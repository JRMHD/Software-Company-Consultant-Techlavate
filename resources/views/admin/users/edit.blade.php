        ...
        <div class="page-header mb-4">
            <div class="d-flex align-items-center gap-3">
                ...
                <div>
                    ...
                    <p class="page-subtitle mb-0">Update user information and permissions</p>
                </div>
            </div>
        </div>
                            ...
                            <div class="row g-4">
                                    ...
                                    <div class="form-group-modern">
                                        ...
                                        <div class="role-selector">
                                            <label class="role-option">
                                                <input type="radio" name="role" value="user" {{ old('role', $user->role) === 'user' ? 'checked' : '' }} required>
                                                <div class="role-card">
                                ...
                                <div class="col-md-12">
                                    <div class="password-section">
                                        ...
                                        <p class="section-note">Leave blank to keep the current password</p>
                                    </div>
                                </div>
