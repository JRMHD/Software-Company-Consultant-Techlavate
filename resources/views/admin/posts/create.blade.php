    ...
    <div class="posts-management">
        ...
        <div class="page-header mb-4">
            <div class="d-flex align-items-center gap-3">
                ...
                <div>
                    <h1 class="page-title mb-1">Create New Post</h1>
                    <p class="page-subtitle mb-0">Write and publish a new blog article</p>
                </div>
            </div>
        </div>
                ...
                <div class="col-lg-8">
                    <div class="modern-card p-4 mb-4">
                        <div class="mb-4">
                            ...
                            <input type="text" class="form-control form-control-lg @error('title') is-invalid @enderror" id="title" name="title" value="{{ old('title') }}" placeholder="Enter post title" required>
                            @error('title')
                        ...
                        <div class="mb-4">
                            ...
                            <textarea class="form-control" id="excerpt" name="excerpt" rows="3" placeholder="Short summary for search results and previews">{{ old('excerpt') }}</textarea>
                    ...
                    <div class="modern-card p-4">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="meta_title" name="meta_title" value="{{ old('meta_title') }}" placeholder="SEO optimized title">
                            <div class="form-text">Leave blank to use post title</div>
                        </div>
                        <div class="mb-3">
                            <label for="meta_description" class="form-label">Meta Description</label>
                            <textarea class="form-control" id="meta_description" name="meta_description" rows="2" placeholder="SEO description for search engines">{{ old('meta_description') }}</textarea>
                        </div>
                    </div>
                </div>
