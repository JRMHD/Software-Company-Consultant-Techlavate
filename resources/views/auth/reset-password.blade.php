...
<head>
    ...
    <!-- SEO Title -->
    <title>Reset Password | Techlavate Solutions</title>
                ...
                <div class="col-lg-5">
                    <div class="login-box" data-aos="fade-up" data-aos-duration="1000">
                        <div class="text-center mb-4">
                            ...
                            <h3 class="text-anime-style-3">Reset Password</h3>
                        ...
                        <form method="POST" action="{{ route('password.store') }}">
                            ...
                            <div class="form-group mt-4">
                                <button type="submit" class="header-btn1 login-btn">
                                    Reset Password <span><i class="fa-solid fa-arrow-right"></i></span>
                                </button>
                            </div>
                        </form>
                    </div>
