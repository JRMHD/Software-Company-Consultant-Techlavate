...
<head>
    ...
    <!-- SEO Title -->
    <title>Register | Techlavate Solutions</title>

    <!-- Meta Description -->
    <meta name="description"
        content="Register for Techlavate Solutions. Empowering businesses with scalable Microsoft solutions.">
                ...
                <div class="col-lg-5">
                    <div class="login-box" data-aos="fade-up" data-aos-duration="1000">
                        <div class="text-center mb-4">
                            ...
                            <h3 class="text-anime-style-3">Create Account</h3>
                            <p>Join Techlavate Solutions today</p>
                        </div>
